...
Using predefined thresholds, the system classifies the detected motion into activity states such as Standby, Walking, or Running, and outputs the results in real time through the serial interface or a connected application.
